...
def create_state_stack(
    ...
    # ";1.e4 d5 2.Nc3 dxe4 3.Nxe4 c6 4.Ng3 e6 5.Nf3 Be7 6.Bc4 Nf6 7.d4 O-O 8.c3 Nd5 9.O-O b5 10.Bb3 a5 11.a4 b4 12.c4 Nf6 13.Bf4 c5 14.Qd3 cxd4 15.Qxd4 Qxd4 16.Nxd4 Bc5 17.Rad1 Bb7 18.Bc2 Nc6 19.Nb5 Rad8 20.b3 Rxd1 21.Rxd1 Rd8 22.Rxd8+ Nxd8 23.Kf1 h6 24.Bc7 Nc6 25.Nd6 Ba8 26.Nde4 Ne7 27.Nxf6+ gxf6 28.Ne4 Bxe4 29.Bxe4 f5 30.Bf4 Kg7 31.Bf3 Ng6 32.Bc7 e5 33.Bxa5 e4 34.Be2 ,"(1880.0, 2029.0]",4"
    # For ;1.e4 e5 2.Nf3, ";1.e4" = idx 0, " e5" = idx 1, " 2.Nf3" = idx 2
    
    # ;1. 11-16 23-18 2. 16-20 24-19 3. 10-14 18-15 4. 7-10 22-17 5. 9-13 27-23 6. 13x22 25x18x9 7. 5x14 29-25 8. 3-7 32-27 9. 7-11 26-22 10. 11x18 22x15 11. 8-11 15x8 12. 4x11 25-22 13. 11-16 30-26 14. 14-18 22x15 15. 10-14 26-22 16. 14-18 23x14 17. 16x23x32 14-10 18. 32-27 31x24 19. 20x27 22-18 20. 27-31 10-7 21. 2x11 15x8 22. 6-10 18-14 23. 10x17 21x14 24. 1-6 8-3 25. 31-26 3-7 1/2-1/2               
    # 2 2 1 2 1 spaces
    ###
    # Toggle dot 2 space , dot 2 space 
    ###
    #;1. 11-15 23-19 2. 8-11 22-17 3. 11-16 24-20 4. 16x23 27x18x11 5. 7x16 20x11 6. 3-7 25-22 7. 7x16 22-18 8. 9-14 18x9 9. 6x13x22 26x17 10. 5-9 28-24 11. 1-6 30-26 12. 10-15 29-25 13. 2-7 25-22 14. 4-8 32-28 15. 7-10 24-20 16. 16-19 20-16 17. 19-24 28x19 18. 15x24 22-18 19. 12x19 17-14 20. 10x17 21x14x5 21. 6-9 5-1 22. 9-13 1-6 23. 24-28 6-10 24. 28-32 18-15 25. 8-12 15-11 26. 12-16 1/2-1/2         
    ...
    # expanded_states = [item for item in initial_states]
    # ##
    # #58 IS THE MAX MOVES IN TRAIN AND 57 IS THE MAX MOVES IN VAL
    # ##
    # for _ in range(59 - len(initial_states)):
    #     expanded_states.append(initial_states[-1])
...
def create_state_stacks(
    ...
    for idx, pgn_string in enumerate(moves_strings):
        ...
        # print("*"*100)
        # print(pgn_string,len(pgn_string))
