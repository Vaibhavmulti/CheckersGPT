...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/home/vaibhav/nanogpt/CheckersGPT/data/checkers_games/output.csv')
    ...
    # Calculate the length of the dataset in characters
    # length_of_dataset_in_characters = len(data)
